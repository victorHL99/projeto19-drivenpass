...
function createWifi(network) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, client.network.create({
                    data: network
                })];
        });
    });
...
function getAllWifi(userId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, client.network.findMany({
                    where: {
                        userId: userId
                    }
                })];
...
function getWifiById(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, client.network.findUnique({
                    where: {
                        id: id
                    }
                })];
...
function deleteWifiById(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, client.network["delete"]({
                    where: {
                        id: id
                    }
                })];
